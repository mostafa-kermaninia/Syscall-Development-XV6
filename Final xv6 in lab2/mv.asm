...
int main(int argc, char *argv[]) {
  ...
  34:	e8 22 03 00 00       	call   35b <move_file>
  ...
  40:	50                   	push   %eax
  41:	50                   	push   %eax
  42:	68 6c 07 00 00       	push   $0x76c
  47:	6a 01                	push   $0x1
  49:	e8 d2 03 00 00       	call   420 <printf>
 ...
 388:	89 d1                	mov    %edx,%ecx
{
 ...
 3bb:	0f b6 92 e4 07 00 00 	movzbl 0x7e4(%edx),%edx
 ...
 429:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 494:	ff 24 85 8c 07 00 00 	jmp    *0x78c(,%eax,4)
 ...
 5a0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5a5:	bb 85 07 00 00       	mov    $0x785,%ebx
...
free(void *ap)
{
 ...
 5b1:	a1 80 0a 00 00       	mov    0xa80,%eax
{
 ...
 5ef:	5b                   	pop    %ebx
  freep = p;
 5f0:	a3 80 0a 00 00       	mov    %eax,0xa80
}
 5f5:	5e                   	pop    %esi
 5f6:	5f                   	pop    %edi
 5f7:	5d                   	pop    %ebp
 ...
 606:	72 ce                	jb     5d6 <free+0x26>
{
 ...
 627:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 62a:	a3 80 0a 00 00       	mov    %eax,0xa80
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 649:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 64c:	8b 15 80 0a 00 00    	mov    0xa80,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 68b:	3b 05 80 0a 00 00    	cmp    0xa80,%eax
 ...
 6ae:	e8 fd fe ff ff       	call   5b0 <free>
  return freep;
 6b3:	8b 15 80 0a 00 00    	mov    0xa80,%edx
 ...
 6dc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6df:	89 15 80 0a 00 00    	mov    %edx,0xa80
}
 ...
 6ef:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 6f0:	c7 05 80 0a 00 00 84 	movl   $0xa84,0xa80
 6f7:	0a 00 00 
    base.s.size = 0;
 6fa:	b8 84 0a 00 00       	mov    $0xa84,%eax
    base.s.ptr = freep = prevp = &base;
 6ff:	c7 05 84 0a 00 00 84 	movl   $0xa84,0xa84
 706:	0a 00 00 
    base.s.size = 0;
 709:	c7 05 88 0a 00 00 00 	movl   $0x0,0xa88
 710:	00 00 00 
    if(p->s.size >= nunits){
