 ...
 38c:	89 d1                	mov    %edx,%ecx
{
 ...
 3b9:	0f b6 92 14 08 00 00 	movzbl 0x814(%edx),%edx
 ...
 439:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4a9:	ff 24 85 bc 07 00 00 	jmp    *0x7bc(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5b7:	90                   	nop
          s = "(null)";
 5b8:	ba b5 07 00 00       	mov    $0x7b5,%edx
        while(*s != 0){
 ...
 5d1:	a1 bc 0a 00 00       	mov    0xabc,%eax
{
 ...
 611:	5b                   	pop    %ebx
  freep = p;
 612:	89 15 bc 0a 00 00    	mov    %edx,0xabc
}
 618:	5e                   	pop    %esi
 619:	5f                   	pop    %edi
 61a:	5d                   	pop    %ebp
 ...
 649:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 64c:	89 15 bc 0a 00 00    	mov    %edx,0xabc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 3d bc 0a 00 00    	mov    0xabc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6af:	73 4f                	jae    700 <malloc+0xa0>
    ...
    if(p == freep)
 6b1:	8b 3d bc 0a 00 00    	mov    0xabc,%edi
 ...
 6da:	e8 f1 fe ff ff       	call   5d0 <free>
  return freep;
 6df:	8b 15 bc 0a 00 00    	mov    0xabc,%edx
 ...
 70c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 70f:	89 15 bc 0a 00 00    	mov    %edx,0xabc
}
 ...
 71f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 720:	c7 05 bc 0a 00 00 c0 	movl   $0xac0,0xabc
 727:	0a 00 00 
    base.s.size = 0;
 72a:	bf c0 0a 00 00       	mov    $0xac0,%edi
    base.s.ptr = freep = prevp = &base;
 72f:	c7 05 c0 0a 00 00 c0 	movl   $0xac0,0xac0
 736:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 739:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 73b:	c7 05 c4 0a 00 00 00 	movl   $0x0,0xac4
 742:	00 00 00 
    if(p->s.size >= nunits){
