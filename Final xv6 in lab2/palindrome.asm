...
free(void *ap)
{
 ...
 5d1:	a1 a0 0a 00 00       	mov    0xaa0,%eax
{
 ...
 611:	5b                   	pop    %ebx
  freep = p;
 612:	89 15 a0 0a 00 00    	mov    %edx,0xaa0
}
 618:	5e                   	pop    %esi
 619:	5f                   	pop    %edi
 61a:	5d                   	pop    %ebp
 ...
 649:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 64c:	89 15 a0 0a 00 00    	mov    %edx,0xaa0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 3d a0 0a 00 00    	mov    0xaa0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6af:	73 4f                	jae    700 <malloc+0xa0>
    ...
    if(p == freep)
 6b1:	8b 3d a0 0a 00 00    	mov    0xaa0,%edi
 ...
 6da:	e8 f1 fe ff ff       	call   5d0 <free>
  return freep;
 6df:	8b 15 a0 0a 00 00    	mov    0xaa0,%edx
 ...
 727:	0a 00 00 
    base.s.size = 0;
 72a:	bf a4 0a 00 00       	mov    $0xaa4,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 739:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 73b:	c7 05 a8 0a 00 00 00 	movl   $0x0,0xaa8
 742:	00 00 00 
    if(p->s.size >= nunits){
